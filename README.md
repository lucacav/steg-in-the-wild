...
* [SteamHide exploits Steam profile images to download malware (archive.org)](https://web.archive.org/web/20210718145830/https://www.gdatasoftware.com/blog/steamhide-malware-in-profile-images): malicious encrypted code is placed within the PropertyTagICCProfile value
...
* [Enterprises in Japan and Europe attacked also by using Mimikatz (archive.org)](https://web.archive.org/web/20200927215306/https://ics-cert.kaspersky.com/reports/2020/06/17/steganography-in-attacks-on-industrial-enterprises/): malicious XLS containing Trojan.MSExcel.Agent.be are used to retrieve an image hiding the Trojan-PSW.PowerShell.Mimikatz
...
* [Stegoware-3PC (archive.org)](https://web.archive.org/web/20210224182858/https://www.scmagazine.com/home/security-news/malware/stegoware-3pc-marks-new-high-in-adware-sophistication/): malware can redirect iOS 12 devices to a phishing site by injecting data in PNG images
...
* [AdGholas Malvertising Campaigns](https://www.proofpoint.com/us/threat-insight/post/massive-adgholas-malvertising-campaigns-use-steganography-and-file-whitelisting-to-hide-in-plain-sight): data is embedded in various images (the [Astrum/Stegano (archive.org)](https://web.archive.org/web/20211207061802/https://blog.trendmicro.com/exploit-kit-attacks-on-the-rise-as-astrum-emerges/) exploit kit is used)
...
* [FAKEM RAT (archive.org)](https://web.archive.org/web/20220308132732/https://www.trendmicro.de/cloud-content/us/pdfs/security-intelligence/white-papers/wp-fakem-rat.pdf): C&C communications are camouflaged in Yahoo! Messenger and MSN Messenger as well as HTTP (**strictly not network steganography!**)
...
* F. Strachanski, D. Petrov, T. Schmidbauer, S. Wendzel, [A Comprehensive Pattern-based Overview of Stegomalware](https://dl.acm.org/doi/abs/10.1145/3664476.3670886), Proc. of the 19th International Conference on Availability, Reliability and Security, Vienna, Austria, 30 July - 2 August 2024, pp. 77:1 - 77:10. 
